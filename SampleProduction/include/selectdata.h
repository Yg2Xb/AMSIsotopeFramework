...
// Sat Nov 15 20:23:04 2025 by ROOT version 6.32.06
// from TTree amstreea/amstreea
// found on file: /eos/ams/user/z/zuhao/yanzx/ams_data/amsd69n_IHEPQcutDST/1305853512_10.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/ams/user/z/zuhao/yanzx/ams_data/amsd69n_IHEPQcutDST/1305853512_10.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/ams/user/z/zuhao/yanzx/ams_data/amsd69n_IHEPQcutDST/1305853512_10.root");
      }
...
void selectdata::Init(TTree *tree)
{
   ...
   */
   ...
   fChain->SetBranchAddress("mcutoff", mcutoff, &b_mcutoff);
   */
   ...
   */
   fChain->SetBranchAddress("btstat", &btstat, &b_btstat);
   fChain->SetBranchAddress("btstat_pR", &btstat_pR, &b_btstat_pR);
   ...
   */
   fChain->SetBranchAddress("charge_pR", &charge_pR, &b_charge_pR);
   ...
   */
   fChain->SetBranchAddress("cutoffp", cutoffp, &b_cutoffp);
   ...
   fChain->SetBranchAddress("tof_betah_oldtune", &tof_betah_oldtune, &b_tof_betah_oldtune);
