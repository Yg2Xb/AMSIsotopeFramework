...
OLD_MC="/afs/cern.ch/user/z/zixuan/public/logMC"
NEW_MC="/afs/cern.ch/user/z/zixuan/public/logMC"

OLD_ISS="/afs/cern.ch/user/z/zixuan/public/logISS"
NEW_ISS="/afs/cern.ch/user/z/zixuan/public/logISS"
