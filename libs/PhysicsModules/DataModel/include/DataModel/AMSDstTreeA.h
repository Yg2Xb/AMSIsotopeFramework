...
// Fri Aug 29 22:52:03 2025 by ROOT version 6.36.02
// from TTree amstreea/amstreea
// found on file: root://eosams.cern.ch//eos/ams/user/z/zuhao/yanzx/ams_data/amsd69n_IHEPQcutDST/1305853512_10.root
//////////////////////////////////////////////////////////

#ifndef AMSDstTreeA_h
#define AMSDstTreeA_h
...
#ifdef AMSDstTreeA_cxx
AMSDstTreeA::AMSDstTreeA(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://eosams.cern.ch//eos/ams/user/z/zuhao/yanzx/ams_data/amsd69n_IHEPQcutDST/1305853512_10.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://eosams.cern.ch//eos/ams/user/z/zuhao/yanzx/ams_data/amsd69n_IHEPQcutDST/1305853512_10.root");
      }
...
AMSDstTreeA::~AMSDstTreeA()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t AMSDstTreeA::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t AMSDstTreeA::LoadTree(Long64_t entry)
{
...
void AMSDstTreeA::Init(TTree *tree)
{
...
void AMSDstTreeA::Show(Long64_t entry)
{
...
Int_t AMSDstTreeA::Cut(Long64_t entry)
{
