  ...
  for (const auto& detector : detectors) {
    ...
    for (int y_bin = 1; y_bin <= n_bins_y; ++y_bin) {
      ...
      if (h2d_raw_L1.count(elN) && h2d_raw_L2.count(elN) && currentBinPureTemplates.count(elO)) {
        ...
        TemplatePurger purger(elN, {elO}, elementZ.at(elN) - 0.5, elementZ.at(elO) + 0.5);
        ...
        if (res1.fitStatus <= 1) {
          TemplatePurger purger2(elN, {elO}, elementZ.at(elN) - 0.5, elementZ.at(elO) + 0.5);
      ...
      if (h2d_raw_L1.count(elC) && h2d_raw_L2.count(elC) && currentBinPureTemplates.count(elN) && currentBinPureTemplates.count(elO)) {
        ...
        TemplatePurger purger(elC, {elN, elO}, elementZ.at(elC) - 0.5, elementZ.at(elO) + 0.5);
        ...
        if (res1.fitStatus <= 1) {
          TemplatePurger purger2(elC, {elN, elO}, elementZ.at(elC) - 0.5, elementZ.at(elO) + 0.5);
      ...
      if (h2d_raw_L1.count(elB) && h2d_raw_L2.count(elB) && currentBinPureTemplates.count(elC) && currentBinPureTemplates.count(elN)) {
        ...
        TemplatePurger purger(elB, {elC, elN}, elementZ.at(elB) - 0.5, elementZ.at(elN) + 0.5);
        ...
        if (res1.fitStatus <= 1) {
          TemplatePurger purger2(elB, {elC, elN}, elementZ.at(elB) - 0.5, elementZ.at(elN) + 0.5);
      ...
      if (h2d_raw_L1.count(elBe) && h2d_raw_L2.count(elBe) && currentBinPureTemplates.count(elB) && currentBinPureTemplates.count(elC)) {
        ...
        TemplatePurger purger(elBe, {elB, elC}, elementZ.at(elBe) - 0.5, elementZ.at(elC) + 0.5);
        ...
        if (res1.fitStatus <= 1) {
          TemplatePurger purger2(elBe, {elB, elC}, elementZ.at(elBe) - 0.5, elementZ.at(elC) + 0.5);
